...
class report_8_1:
    ...
    def report_8_1_0_search(self, code, eventname, result):
        ...
        try:
            ...
            var_stx.driver.find_element(By.XPATH, var_stx.daterangepicker_end).clear()
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.daterangepicker_end).send_keys("03/03/2025 16:32")
            time.sleep(1)
            var_stx.driver.find_element(By.XPATH, var_stx.apply).click()
            time.sleep(1.5)
            var_stx.driver.find_element(By.XPATH, var_stx.search).click()
    ...
    def report_8_1_8_search(self, code, eventname, result):
        ...
        var_stx.driver.find_element(By.XPATH, var_stx.from_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.from_day).send_keys("18/12/2024 00:00")
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("19/12/2024 23:59")
    ...
    def report_8_1_11_search(self, code, eventname, result):
        ...
        var_stx.driver.find_element(By.XPATH, var_stx.from_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.from_day).send_keys("16/12/2024 00:00")
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("16/12/2024 17:00")
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.search).click()
        time.sleep(5)
        try:
    ...
    def report_8_1_12_search(self, code, eventname, result):
        ...
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("17/12/2024 16:00")
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.search).click()
        time.sleep(5)
        try:
...
class report_8_3:
    ...
    def report_8_3_1_search(self, code, eventname, result):
        ...
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("18/12/2024 00:00")
        time.sleep(1)
        var_stx.driver.find_element(By.XPATH, var_stx.search).click()
        time.sleep(5)
        try:
    ...
    def report_8_3_2_search(self, code, eventname, result):
        ...
        var_stx.driver.find_element(By.XPATH, var_stx.from_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.from_day).send_keys("17/12/2024 11:00")
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("17/12/2024 12:00")
        time.sleep(1)
        var_stx.driver.find_element(By.XPATH, var_stx.search).click()
        time.sleep(5)
        try:
...
class report_8_4:
    ...
    def report_8_4_2_search(self, code, eventname, result):
        ...
        try:
            ...
            var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("3/3/2025 23:59")
            time.sleep(1)
            var_stx.driver.find_element(By.XPATH, var_stx.sdt_custommer).click()
            time.sleep(1)
            var_stx.driver.find_element(By.XPATH, var_stx.search).click()
    ...
    def report_8_4_4_search(self, code, eventname, result):
        ...
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
        time.sleep(0.5)
        var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("23/12/2024 00:00")
        time.sleep(1)
        var_stx.driver.find_element(By.XPATH, var_stx.search).click()
        time.sleep(5)
        try:
            ...
            var_stx.driver.find_element(By.XPATH, var_stx.from_day).clear()
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.from_day).send_keys("17/11/2024 00:00")
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("3/3/2025 23:59")
    ...
    def report_8_4_7_search(self, code, eventname, result):
        ...
        try:
            ...
            var_stx.driver.find_element(By.XPATH, var_stx.from_day).clear()
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.from_day).send_keys("2/3/2025 17:3")
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.to_day).clear()
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.to_day).send_keys("3/3/2025 17:3")
            time.sleep(1)
            var_stx.driver.find_element(By.XPATH, var_stx.search).click()
            time.sleep(5)
    ...
    def report_8_4_8_search(self, code, eventname, result):
        ...
        try:
            ...
            var_stx.driver.find_element(By.XPATH, var_stx.from_day).clear()
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.from_day).send_keys("02/01/2024 00:00")
            time.sleep(0.5)
            var_stx.driver.find_element(By.XPATH, var_stx.search).click()
            time.sleep(7)
